...
from rest_framework.decorators import action #serve para auterar ações dentro do modelView
...
class CursoViewSet(viewsets.ModelViewSet):
    ...
    # para criar uma nova rota por isso o import do decorators
...
# a baixo temos o viewsets só que aberto onde posso escolher as funções que vou usar (get, post ...)
